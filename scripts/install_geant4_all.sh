...
sudo wget http://geant4.web.cern.ch/geant4/support/source/${GEANT_VERSION}.tar.gz
...
sudo cmake -DCMAKE_INSTALL_PREFIX=../${GEANT_VERSION}-build/ -DGEANT4_INSTALL_DATA=ON -DGEANT4_USE_OPENGL_X11=ON -DGEANT4_USE_RAYTRACER_X11=ON -DGEANT4_USE_QT=ON -DGEANT4_USE_G3TOG4=ON -DGEANT4_USE_INVENTOR=ON -DGEANT4_USE_XM=ON -DINVENTOR_SOXT_LIBRARY=${INSTALL_FOLDER}/geant4_prerequisites/SoXt-1.3.0/lib/libSoXt.so -DINVENTOR_INCLUDE_DIR=${INSTALL_FOLDER}/geant4_prerequisites/Coin-3.1.3/include -DINVENTOR_LIBRARY=${INSTALL_FOLDER}/geant4_prerequisites/Coin-3.1.3/lib/libCoin.so -DINVENTOR_SOXT_INCLUDE_DIR=${INSTALL_FOLDER}/geant4_prerequisites/SoXt-1.3.0/include ../${GEANT_VERSION}/
#==========Cmake options
